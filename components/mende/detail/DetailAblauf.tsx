...
import type { DetailseiteAblauf } from "@/tina/__generated__/types";

export type DetailAblaufProps = Partial<DetailseiteAblauf>;
 ...
 */
export const DetailAblauf: React.FC<DetailAblaufProps> = ({
  eyebrow,
  heading,
  steps,
}) => {
