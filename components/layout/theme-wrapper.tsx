 ...
 *
 * Die Berechnung läuft hier clientseitig, weil die Theme-Farbe über useTina
 * (useLayout().theme) kommt — so läuft die Farbe im Editor live mit.
 */
...
export const ThemeWrapper: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  const bordeaux = theme?.color || "#800000";
